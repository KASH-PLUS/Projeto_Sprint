...
public class ThreadInsert extends Thread {
    ...
    private void insertRegistro(Integer fkComponente, String tipo) throws IOException {
        ...
        if (tipo.equals("disco")) {
            cursor.update(String.format(Locale.US,"INSERT INTO tbRegistro(fkComponente, registro, dataHora) VALUES ( '%s', %d, '%s' )", fkComponente, usoDisco, dataHora));
            ...
            cursor.update(String.format(Locale.US,"INSERT INTO tbRegistro(fkComponente, registro, dataHora) VALUES ( '%s', %.2f, '%s' )", fkComponente, usoMemoria, dataHora));
            System.out.println("Insert realizado");
            ...
            cursor.update(String.format(Locale.US,"INSERT INTO tbRegistro(fkComponente, registro, dataHora) VALUES ( '%s', %.2f, '%s' )", fkComponente, usoCpu, dataHora));
            System.out.println("Insert realizado");
